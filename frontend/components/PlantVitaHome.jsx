...
{/* ================= DEMO PLANT ================= */}
{session?.user?.name?.toLowerCase() !== "varun kumar" && (
...
{session?.user?.name?.toLowerCase() === "varun kumar" && (
  ...
  <section className="px-8 pb-6">
    ...
    <Card
      ...
      className="w-72 h-28 rounded-2xl border border-green-300 
    ...
    >
      ...
      <CardContent className="p-4 flex items-center gap-4">
        ...
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 rounded-xl bg-green-400/10 blur-sm"></div>
        </div>
